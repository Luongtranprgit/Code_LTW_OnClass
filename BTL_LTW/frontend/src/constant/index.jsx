...
export const categories = [
  { id: 1, name: "Hài hước", icon: FaMehRollingEyes },
  { id: 2, name: "Khoa học viễn tưởng", icon: FaCodepen },
  { id: 3, name: "Lãng mạng", icon: FaCanadianMapleLeaf },
  { id: 4, name: "Phép thuật", icon: FaStarOfDavid },
  { id: 5, name: "Phiêu lưu", icon: FaFeatherAlt },
];
